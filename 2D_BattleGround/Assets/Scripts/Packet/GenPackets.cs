...
public class C_WaterBOOM : IPacket
{
	public int roomID;
	public int CGUID;
	public int CellPosX;
	...
	public ushort Protocol { get { return (ushort)PacketID.C_WaterBOOM; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.C_WaterBOOM), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.roomID), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.CGUID), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class S_WaterBOOM : IPacket
{
	...
	public ushort Protocol { get { return (ushort)PacketID.S_WaterBOOM; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_WaterBOOM), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.CGUID), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
...
public class S_PlayerHit : IPacket
{
	public int CGUID;
	public int Damage;
	public int HitPlayerLeftHP;

	public ushort Protocol { get { return (ushort)PacketID.S_PlayerHit; } }
	...
	public void Read(ArraySegment<byte> segment)
	{
		...
		count += sizeof(int);
		this.HitPlayerLeftHP = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
	}
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_PlayerHit), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.CGUID), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.Damage), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.HitPlayerLeftHP), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
...
public class S_PlayerDie : IPacket
{
	...
	public void Read(ArraySegment<byte> segment)
	{
		...
		this.CGUID = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
		this.AttackerCGUID = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
		this.Damage = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
	}
	...
	public ArraySegment<byte> Write()
	{
		...
		Array.Copy(BitConverter.GetBytes(this.CGUID), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.AttackerCGUID), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.Damage), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
...
public class C_GameFinish : IPacket
{
	public int roomID;

	public ushort Protocol { get { return (ushort)PacketID.C_GameFinish; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.C_GameFinish), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.roomID), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
...
public class C_FieldToLobby : IPacket
{
	public int CGUID;
	public int RoomID;

	public ushort Protocol { get { return (ushort)PacketID.C_FieldToLobby; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.C_FieldToLobby), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.CGUID), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.RoomID), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class C_SkillState : IPacket
{
	...
	public void Read(ArraySegment<byte> segment)
	{
		...
		this.CGUID = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
		this.SpeedUpPoint = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
		this.RangeUpPoint = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
		this.PowerUpPoint = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
		this.WaterCountUpPoint = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
	}
	...
	public ArraySegment<byte> Write()
	{
		...
		Array.Copy(BitConverter.GetBytes(this.CGUID), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.SpeedUpPoint), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.RangeUpPoint), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.PowerUpPoint), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.WaterCountUpPoint), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
...
public class S_SkillState : IPacket
{
	...
	public void Read(ArraySegment<byte> segment)
	{
		...
		count += sizeof(ushort);
		count += sizeof(ushort);
		this.Speed = BitConverter.ToInt32(segment.Array, segment.Offset + count);
		count += sizeof(int);
	}
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.Speed), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
